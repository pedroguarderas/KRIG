...
Loading data, inside the package **KRIG**.
...
Estimation of the right parameters to construct the kernel, fitting the variogram.
...
Plotting results for the variogram.
```{r varg,eval=TRUE,fig.show='hold', fig.show='hold', fig.align="center", fig.width=7, fig.height=4}
...
Solving ordinary kriging problem.
...
Level curves
```{r curv,eval=TRUE,fig.show='hold', fig.show='hold', fig.align="center", fig.width=7, fig.height=4}
